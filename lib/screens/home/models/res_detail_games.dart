class ResDetailGame {
  ...
  factory ResDetailGame.fromJson(Map<String, dynamic> json) => ResDetailGame(
        id: json["id"],
        slug: json["slug"],
        name: json["name"],
        ...
        metacriticPlatforms: json["metacritic_platforms"] == null
            ? []
            : List<MetacriticPlatform>.from(json["metacritic_platforms"].map((x) => MetacriticPlatform.fromJson(x))),
        ...
        alternativeNames:
            json["alternative_names"] == null ? [] : List<String>.from(json["alternative_names"].map((x) => x)),
        ...
        developers: json["developers"] == null
            ? []
            : List<Developer>.from(json["developers"].map((x) => Developer.fromJson(x))),
        ...
        publishers: json["publishers"] == null
            ? []
            : List<Developer>.from(json["publishers"].map((x) => Developer.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "metacritic_platforms":
            metacriticPlatforms == null ? [] : List<dynamic>.from(metacriticPlatforms!.map((x) => x.toJson())),
        "released":
